<header class="bg-blue-900 text-white p-4">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <nav class="hidden md:flex items-center space-x-4">
            ...
            <x-nav-link url='/jobs/saved' :active="request()->is('job/saved')">Saved Jobs</x-nav-link>
    ...
    <nav id="mobile-menu" class="hidden md:hidden bg-blue-900 text-white mt-5 pb-4 space-y-2">
        ...
        <x-nav-link url='/jobs/saved' :active="request()->is('job/saved')" :mobile='true'>Saved Jobs</x-nav-link>
